...
| Enter a fictional guardian name and example.org email. | 8 | Pass |
| See the count move | 4 | Pass |
| The class changes from two open seats to one. | 9 | Pass |
| A narrow tool | 3 | Pass |
| It counts seats, not students | 5 | Pass |
...
| Version 0.1.0 · Original abacus art drawn for this product. | 10 | Pass |

Read-aloud check: “Show the right number of class seats. For schools whose
booking calendar and room list disagree about places. Try it with sample data.”
