      ...
      <section className="hero page-width" aria-labelledby="home-title">
        <div className="hero-copy paper-panel">
          ...
          <ul className="plain-facts" aria-label="What the sample proves">
            <li>Available seats change after a sample booking.</li>
            <li>Full and closed sample classes block bookings.</li>
            <li>Demo changes stay separate and reset.</li>
          </ul>
        </div>
...
function formatStart(timestamp: number) {
  return new Intl.DateTimeFormat("en-GB", { weekday: "short", day: "numeric", month: "short", hour: "2-digit", minute: "2-digit", timeZone: "Europe/London" }).format(new Date(timestamp * 1000));
}
